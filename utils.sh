...
APP_NAME="${APP_NAME:-Quantum Workspace}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-QuantumTechnologies/quantum-workspace}"
BINARY_NAME="${BINARY_NAME:-quantum-workspace}"
GH_REPO_PATH="${GH_REPO_PATH:-QuantumTechnologies/quantum-workspace}"
ORG_NAME="${ORG_NAME:-QuantumTechnologies}"
