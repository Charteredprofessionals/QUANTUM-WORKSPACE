...
exports.SimpleModeHandler = void 0;
...
class SimpleModeHandler {
    ...
    async showSimpleMode() {
        const panel = vscode.window.createWebviewPanel('quantumSimpleMode', 'Quantum Workspace', vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
    ...
    async handleGoalSelection(goal) {
        if (!this.llmRouter)
            return;
        vscode.window.showInformationMessage(`🎯 Building your ${goal.name}... This may take a moment.`);
        try {
...
Use modern best practices.`,
            ...
            vscode.window.showInformationMessage(`✅ Your ${goal.name} is ready! Check the files in the explorer.`);
...
exports.SimpleModeHandler = SimpleModeHandler;
